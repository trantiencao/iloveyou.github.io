...
/* Developed by Alexander Burtsev */
! function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : a(jQuery) }(function(a) {
    "use strict";

    function b(b, c) { a.extend(this, { speed: 10, text: "", cursor: !0, blinkSpeed: 2, typeFrom: "end", cursorStyles: { display: "inline-block", fontStyle: "normal", margin: "-2px 2px 0 2px" } }, c || {}), this._cursor = null, this._element = a(b), this._element.data("typist", this), this._container = null, this.queue = [], this.timer = null, this.delay = 1e3 / this.speed, this.blinkTimer = null, this.blinkDelay = 1e3 / this.blinkSpeed, this.text && (this.queue.push({ text: this.text }), this.type()) }
    a.fn.typistInit = function() { return this.each(function() { a(this).data("typist") || new b(this) }) }, a.fn.typist = function(a) { return this.each(function() { new b(this, a) }) }, a.fn.typistAdd = function(b, c) {
        return this.typistInit().each(function() {
            var d = a(this).data("typist");
            d.queue.push({ text: b, callback: c }), d.type()
        })
    }, a.fn.typistRemove = function(b, c) {
        return b = parseInt(b) || 0, this.typistInit().each(function() {
            var d = a(this).data("typist");
            d.queue.push({ remove: b, callback: c }), d.type()
        })
    }, a.fn.typistPause = function(b, c) {
        return b = parseInt(b) || 0, this.typistInit().each(function() {
            var d = a(this).data("typist");
            d.queue.push({ delay: b, callback: c }), d.type()
        })
    }, a.fn.typistStop = function() {
        return this.typistInit().each(function() {
            var b = a(this).data("typist");
            b.queue.push({ stop: !0 }), b.type()
        })
    }, b.prototype = {
        addCursor: function() { this._cursor && (clearInterval(this.blinkTimer), this._cursor.stop().remove()), this._cursor = a("<span>|</span>").css(this.cursorStyles).insertAfter(this._container), this.cursorVisible = !0, this.blinkTimer = setInterval(a.proxy(function() { this.cursorVisible = !this.cursorVisible, this._cursor.animate({ opacity: this.cursorVisible ? 1 : 0 }, 100) }, this), this.blinkDelay) },
        fire: function(a) { return this._element.trigger(a, this), this },
        nl2br: function(a) { return a.replace(/\n/g, "<br>") },
        br2nl: function(a) { return a.replace(/<br.*?>/g, "\n") },
        remove: function(b, c) {
            if (0 >= b) return c(), this.timer = null, this.fire("end_remove.typist").type();
            var d = this._container.html();
            b--, d = this.br2nl(d), d = d.substr(0, d.length - 1), d = this.nl2br(d), this.timer = setTimeout(a.proxy(function() { this._container.html(d), this.remove(b, c) }, this), this.delay), this.fire("tick.typist")
        },
        step: function(b, c) {
            if ("string" == typeof b && (b = b.split("")), !b.length) return c(), this.timer = null, this.fire("end_type.typist").type();
            var d = b.shift();
            d = a("<div>").text(d).html(), d = this.nl2br(d), this.timer = setTimeout(a.proxy(function() { this._container.html(this._container.html() + d), this.step(b, c) }, this), this.delay), this.fire("tick.typist")
        },
        stop: function() { clearInterval(this.blinkTimer), this.blinkTimer = null, this._cursor && (this._cursor.remove(), this._cursor = null), clearTimeout(this.timer), this.timer = null },
        type: function() {
            if (!this.timer) {
                this._container || (this._container = a("<span>"), "start" === this.typeFrom ? this._element.prepend(this._container) : this._element.append(this._container)), this.cursor && this.addCursor();
                var b = this.queue.shift() || {},
                    c = a.proxy(b.callback || a.noop, this);
...
(function(d) {
    d(document).ready(function(a) {
        a("body").vegas({ slides: [{ src: "https://i.imgur.com/36GsFBT.jpg" }], preloadImage: !0, overlay: !0 });
        a("#txt").typist({ speed: 10 }).typistPause(2E3).typistAdd(" \u2013 Ch\u00e0o em!\n").typistPause(2E3).typistAdd(" \u2013 Em c\u00f3 mu\u1ed1n khi ch\u1ebft...").typistPause(1500).typistAdd(" s\u1ebd c\u00f3 t\u00ean trong gia ph\u1ea3 nh\u00e0 anh kh\u00f4ng? :x").typistPause(700, function() { a("#buttons").fadeIn("fast") });
        var c = !1;
        a("#buttons").on("click", "#btn-yes",
            function(a) { swal("Tuy\u1ec7t v\u1eddi!", "\u0110\u00f3 l\u00e0 c\u00e2u tr\u1ea3 l\u1eddi m\u00e0 anh mong \u0111\u1ee3i!", "success") }).on("click", "#btn-no", function(a) { swal("Th\u1eadt ti\u1ebfc!", "D\u00f9 sao th\u00ec anh c\u0169ng t\u00f4n tr\u1ecdng quy\u1ebft \u0111\u1ecbnh c\u1ee7a em.", "error") }).on("mouseenter", function(e) { c || (c = !0, a(document).mousemove(function(b) { a("#btn-no").css({ position: "fixed", top: b.offsetY + 10, left: b.offsetX + 10 }) })) });
